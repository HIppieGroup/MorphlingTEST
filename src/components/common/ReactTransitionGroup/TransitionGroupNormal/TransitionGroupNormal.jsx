 ...
 * items.
 */
class TransitionGroupNormal extends React.Component {
  ...
  render() {
    ...
    const children = values(this.state.children).reverse().map(childFactory);
...
TransitionGroupNormal.propTypes = {
  /**
...
TransitionGroupNormal.defaultProps = defaultProps;

export default TransitionGroupNormal;
